...
// URLs para GET y PUT
const dataMerchURL = "http://localhost:3030/productos/merchandising/" + merch_param_id_edit;
const putActualizarMerchURL = "http://localhost:3030/admin/merchandising/actualizar/" + merch_param_id_edit;
